  ...
  return (
    ...
    >
      ...
      <div className="bg-white shadow-md">
              ...
              return (
                <li key={item.id} className="relative flex items-center">
                  ...
                  <div className="group">
                    ...
                    {hasSubMenu && (
                      <ul className="absolute left-0 top-full mt-2 bg-white shadow-md rounded-md opacity-0 invisible group-hover:visible group-hover:opacity-100 transition-all duration-300 min-w-[150px] z-50">
        ...
        <div
          ref={menuRef}
          className={`fixed md:hidden left-0 top-[124px] w-full bg-white transition-all duration-500 ease-in-out z-40 ${
                  ...
                  {hasSubMenu && isDeptOpen && (
                    <ul className="bg-gray-100">
                      {item.subMenu.map((sub) => (
                        <li
                          key={sub.id}
                          className="px-6 py-2 border-b hover:bg-[#bbbdbc96]"
                        >
                          <NavLink
                            to={sub.link}
